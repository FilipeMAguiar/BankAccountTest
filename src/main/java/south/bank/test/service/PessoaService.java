...
public class PessoaService {
    ...
    public Pessoa criarPessoa(PessoaRequest request) throws BusinessException {
        ...
        checkScoreAndConta(pessoa, conta, random);
    ...
    private void checkScoreAndConta(Pessoa pessoa, Conta conta, Random random) {
    ...
    private void setPessoa(PessoaRequest request, Pessoa pessoa, Conta conta) {
        ...
        conta.setId(generatorService.generateSequence(Conta.SEQUENCE_NAME));
